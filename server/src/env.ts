...
const schema = z.object({
  ...
  // Sammy's voice (the owl narrator) for /api/voice/tts; the variable keeps its NARRATOR name for the deployed config (the interview agent's voice is set on the agent).
