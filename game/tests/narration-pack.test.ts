...
/** Every line but the few waiting for voice credits (narration/learn.ts). */
...
test("a line waiting for a voice has none yet (once the pack voices it, drop it from AWAITING_VOICE)", () => {
