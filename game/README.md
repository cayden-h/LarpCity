...
- `debt.html` + `src/debt-demo/main.ts`: the Money desk ([design](../research/12-credit-desk-ui.md)), Robinhood-style tabs for Home, Investing, Debt, Credit, and Cards over the city's `PlayerLife` (opened from the phone) or its own (standalone).
