...
- **Phone:** the hub for the game's apps, docked on the left edge (tuck it away with its side tab). Stocks shows a market watchlist and opens the Money desk over the city (city time pauses while it is open); Goals opens the fast-forward; News, Mail, and Bank are coming.
